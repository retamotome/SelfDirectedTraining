...
| Video | Description |
|:--|:----------|
|<a href="https://www.youtube.com/watch?v=Ek5qa6cXapc" target="_blank"><image src="img/Thumbnail.png" width="200"></a>| <sub>:arrow_forward: YouTube<br> 🟢 Chinese 🟢 English ⚪ Japaness</sub><br>敏捷與軟體工程全覽｜敏捷的流程、歷史、應用範圍與比較，以及它如何影響專案管理與PDCA。|
