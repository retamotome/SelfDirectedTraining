...
## ⭐ Agile and Software Engineering 敏捷與軟體工程全覽
敏捷的流程、歷史、應用範圍與比較，以及它如何影響專案管理與PDCA。  
...
## ⭐ Agile Team Introduction 敏捷團隊
正確地打造敏捷團隊，依據 Cynefin Framework 以及所對應的 ARCI 模型。  
...
## ⭐ Business Requirement Definition 商業需求定義 實戰  
